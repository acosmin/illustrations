  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        x2={182.23}
        y2={206.96}
        xlinkHref="#266ddccd-2bf2-4e28-b2e5-5ae966d4800f"
      />
      <linearGradient
    ...
    />
    <rect x={38.55} y={132.2} width={140.18} height={149.52} fill={props.primaryColor} />
    <path
      ...
      fill="#fff"
    />
    <rect x={4.67} y={79.64} width={427.54} height={31.54} fill={props.primaryColor} />
    ...
    <g opacity={0.2}>
      <rect x={587.85} y={566.41} width={79.64} height={13.97} fill={props.primaryColor} />
      <rect
        x={587.85}
        y={592.95}
        width={219.35}
        ...
        fill={props.primaryColor}
      />
      <rect x={587.85} y={619.5} width={219.35} height={13.97} fill={props.primaryColor} />
    </g>
    <polygon
