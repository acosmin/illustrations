...
const UndrawChilling = props => (
  ...
  >
    ...
    <rect x={68.12} y={537.67} width={54.67} height={68.34} fill={props.primaryColor} />
    <rect x={738.37} y={538.18} width={54.67} height={68.34} fill={props.primaryColor} />
    <rect x={838.6} y={537.67} width={54.67} height={68.34} fill={props.primaryColor} />
    <rect x={191.64} y={538.18} width={54.67} height={68.34} fill={props.primaryColor} />
    ...
    <path
      ...
      fill={props.primaryColor}
    />
    <rect x={223.02} y={455.66} width={628.74} height={95.68} fill={props.primaryColor} />
    <rect
      x={382.64}
      y={278.19}
      width={185.66}
    ...
    <path
      ...
      fill={props.primaryColor}
    />
    <rect x={250.36} y={382.77} width={314.37} height={86.57} fill={props.primaryColor} />
    <rect x={565.24} y={383.27} width={314.37} height={86.57} fill={props.primaryColor} />
    <rect
      x={250.36}
      y={382.77}
      width={314.37}
    ...
    <rect x={528.94} y={204.21} width={94.27} height={24.81} fill={props.primaryColor} />
