...
const UndrawSafe = props => (
  ...
  >
    ...
    />
    <rect x={200.07} y={85.48} width={499} height={139} fill={props.primaryColor} />
    <rect
      x={281.07}
      y={287.48}
      width={34}
    ...
    />
    <rect x={282.57} y={289.48} width={32} height={24} fill={props.primaryColor} />
    ...
    <path
      ...
      fill="#fff"
    />
    <rect x={372.07} y={369.48} width={174} height={142} fill={props.primaryColor} />
    <rect x={372.07} y={369.48} width={174} height={142} fill="#fff" />
    <rect x={372.07} y={397.48} width={174} height={86} fill={props.primaryColor} />
    <path
