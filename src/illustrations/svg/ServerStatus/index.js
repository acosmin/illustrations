...
const UndrawServerStatus = props => (
  ...
  >
    ...
    <ellipse cx={508.8} cy={235.5} rx={152.12} ry={67.89} fill={props.primaryColor} />
    <path
    ...
    <path
      ...
      opacity={0.2}
    />
    <circle cx={31.29} cy={21.63} r={21.63} fill={props.primaryColor} opacity={0.1} />
    <circle cx={961.29} cy={83.63} r={21.63} fill={props.primaryColor} opacity={0.1} />
    <circle cx={16} cy={106.18} r={16} fill={props.primaryColor} opacity={0.1} />
    <circle cx={178} cy={16.18} r={16} fill={props.primaryColor} opacity={0.1} />
    <circle cx={834} cy={18.18} r={16} fill={props.primaryColor} opacity={0.1} />
    <path
