...
const UndrawSelect = props => (
  ...
  >
    ...
    <g opacity={0.2}>
      <rect x={276.28} y={368.8} width={89.99} height={15.79} fill={props.primaryColor} />
      <rect x={276.28} y={398.8} width={247.87} height={15.79} fill={props.primaryColor} />
      <rect x={276.28} y={428.8} width={247.87} height={15.79} fill={props.primaryColor} />
    </g>
    <polygon
