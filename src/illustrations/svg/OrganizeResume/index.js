...
const UndrawOrganizeResume = props => (
  ...
  >
    ...
    <g opacity={0.2}>
      <rect x={171.97} y={92.7} width={725.15} height={35.21} fill={props.primaryColor} />
    </g>
    <rect x={171.97} y={127.91} width={725.15} height={416.05} fill="#f6f7f9" />
    ...
    <g opacity={0.2}>
      <rect x={269.78} y={434.41} width={26.08} height={86.08} fill={props.primaryColor} />
      <rect
        x={320.21}
        y={372.67}
        width={26.08}
      ...
      <rect
        ...
        fill={props.primaryColor}
      />
      <rect x={471.5} y={390.06} width={26.08} height={130.42} fill={props.primaryColor} />
    </g>
    <g opacity={0.2}>
      <rect
        x={665.4}
    ...
    <path
      ...
      fill={props.primaryColor}
    />
    <rect x={24.54} y={731.83} width={953} height={7} fill={props.primaryColor} />
    <rect
      x={698.23}
      y={340.83}
      width={201.97}
    ...
    />
    <rect x={701.4} y={344.73} width={195.63} height={240.41} fill={props.primaryColor} />
