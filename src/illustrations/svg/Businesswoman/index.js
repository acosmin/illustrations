...
const UndrawBusinesswoman = props => (
  ...
  >
    ...
    <ellipse cx={421.29} cy={308.68} rx={2.42} ry={4.19} fill={props.primaryColor} />
    ...
    <ellipse cx={427.5} cy={353.61} rx={2.42} ry={4.19} fill={props.primaryColor} />
    <ellipse cx={425.09} cy={329.83} rx={2.42} ry={4.19} fill={props.primaryColor} />
    <ellipse cx={429.92} cy={373.58} rx={2.42} ry={4.19} fill={props.primaryColor} />
    <path
    ...
    <ellipse cx={314.54} cy={419.15} rx={1.13} ry={2.25} fill={props.primaryColor} />
    <ellipse cx={310.03} cy={438.31} rx={1.13} ry={2.25} fill={props.primaryColor} />
    <ellipse cx={306.65} cy={455.86} rx={1.13} ry={2.25} fill={props.primaryColor} />
    <ellipse cx={312.28} cy={428.81} rx={1.13} ry={2.25} fill={props.primaryColor} />
    <ellipse cx={307.77} cy={447.49} rx={1.13} ry={2.25} fill={props.primaryColor} />
    <path
