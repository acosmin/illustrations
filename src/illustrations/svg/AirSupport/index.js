...
const UndrawAirSupport = props => (
  ...
  >
    ...
    <rect x={160.98} y={590.63} width={62.9} height={46.73} fill={props.primaryColor} />
    <path
    ...
    <rect x={172.57} y={596.6} width={1.41} height={11.24} fill={props.primaryColor} />
    <rect x={205.25} y={596.6} width={14.76} height={11.24} fill="#fff" />
    <rect x={211.93} y={596.6} width={1.41} height={11.24} fill={props.primaryColor} />
    <g opacity={0.2}>
      <path
    ...
    <path
      ...
      fill={props.primaryColor}
    />
    <rect x={736.53} y={357.05} width={26.19} height={9.15} fill={props.primaryColor} />
    <g opacity={0.2}>
      <path
    ...
    <rect x={713.25} y={336.26} width={75.26} height={24.53} fill={props.primaryColor} />
    <path
