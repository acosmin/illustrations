...
const UndrawData = props => (
  ...
  >
    ...
    <g opacity={0.2}>
      <rect x={33.62} y={36} width={149} height={9} fill={props.primaryColor} />
    </g>
    ...
    />
    <rect x={204.62} y={363} width={47} height={9} fill={props.primaryColor} />
    <rect x={204.62} y={419} width={47} height={9} fill={props.primaryColor} />
    <rect x={305.62} y={419} width={47} height={9} fill={props.primaryColor} />
    ...
    <g opacity={0.2}>
      <rect x={243.62} y={36} width={149} height={9} fill={props.primaryColor} />
    </g>
    <rect
      x={327.62}
      y={72}
    ...
    />
    <rect x={328.62} y={118} width={16} height={9} fill={props.primaryColor} />
    <rect
      x={30.62}
      y={182}
      width={367}
    ...
    <g opacity={0.2}>
      <rect x={524.62} y={202.68} width={336} height={9} fill={props.primaryColor} />
    </g>
    <rect
      x={522.62}
      y={241.68}
    ...
    />
    <rect x={738.62} y={345.68} width={104} height={16} fill={props.primaryColor} />
    ...
    />
    <rect x={462.12} y={593.18} width={40} height={51} fill={props.primaryColor} />
