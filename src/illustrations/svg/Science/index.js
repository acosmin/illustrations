...
const UndrawScience = props => (
  ...
  >
    ...
    <path
      ...
      opacity={0.1}
    />
    <circle cx={507.53} cy={472.5} r={20.73} fill={props.primaryColor} opacity={0.3} />
    <circle cx={519.37} cy={389.57} r={12.83} fill={props.primaryColor} opacity={0.3} />
    <circle cx={490.74} cy={315.52} r={12.83} fill={props.primaryColor} opacity={0.3} />
    <path
      ...
      opacity={0.2}
    />
    <circle cx={480.37} cy={85.01} r={20.73} fill={props.primaryColor} opacity={0.3} />
    <circle cx={542.56} cy={49.47} r={15.41} fill={props.primaryColor} opacity={0.3} />
    <circle cx={498.14} cy={8.01} r={8.01} fill={props.primaryColor} opacity={0.3} />
    <path
    ...
    <path
      ...
      opacity={0.1}
    />
    <circle cx={198.07} cy={361.59} r={7.24} fill={props.primaryColor} opacity={0.3} />
    <circle cx={221.76} cy={335.92} r={4.61} fill={props.primaryColor} opacity={0.3} />
    <circle cx={189.51} cy={326.71} r={4.61} fill={props.primaryColor} opacity={0.3} />
    <path
      ...
      opacity={0.2}
    />
    <circle cx={213.09} cy={214.5} r={17.59} fill={props.primaryColor} opacity={0.3} />
    <circle cx={160.32} cy={184.34} r={13.08} fill={props.primaryColor} opacity={0.3} />
    <circle cx={198.01} cy={149.16} r={6.8} fill={props.primaryColor} opacity={0.3} />
    <path
