...
const UndrawBlankCanvas = props => (
  ...
  >
    ...
    <polygon
      ...
      fill="#9d9cb5"
    />
    <circle cx={179.99} cy={124.52} r={31.5} fill={props.primaryColor} opacity={0.1} />
    <circle cx={113.99} cy={49.52} r={19.5} fill={props.primaryColor} opacity={0.1} />
    <circle cx={12} cy={93.02} r={12} fill={props.primaryColor} opacity={0.1} />
  </svg>
);
