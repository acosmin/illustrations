...
const UndrawHealthyHabit = props => (
    ...
    transform='translate(-90 -115.91)' fill={props.primaryColor} opacity='0.1' />
    <ellipse cx='137.95' cy='646.08' rx='72.74' ry='22.1' fill={props.primaryColor} opacity='0.1'
    />
    <ellipse cx='825.73' cy='363.42' rx='194.27' ry='12.89' fill={props.primaryColor}
    opacity='0.1' />
    <g opacity='0.5' fill={props.primaryColor}>
        ...
        />
        <rect x='899.59' y='56.37' width='20.32' height='361.84' rx='10.16' ry='10.16'
        ...
        />
        <rect x='1037.4' y='199.13' width='15.92' height='76.32' rx='7.96' ry='7.96'
        transform='rotate(-180 1000.365 179.335)' />
        <rect x='1053.33' y='206.27' width='15.92' height='62.05' rx='7.96' ry='7.96'
    ...
    <g opacity='0.5' fill={props.primaryColor}>
        ...
        />
        <rect x='814.68' y='268.59' width='11.05' height='36.83' />
        <rect x='792.58' y='310.02' width='11.05' height='36.83' />
        <rect x='838.62' y='310.02' width='11.05' height='36.83' />
        <rect x='782.46' y='302.65' width='75.5' height='10.13' />
    </g>
    <ellipse cx='473.09' cy='577.95' rx='414.32' ry='30.38' fill={props.primaryColor}
    opacity='0.1' />
    ...
    transform='translate(-90 -115.91)' fill={props.skinColor} />
    <path d='M670.36,585.67s28.54,12.89,42.35,12.89c0,0,14.73,3.68,23,7.37s40.51,5.52,40.51,5.52,37.75,13.81,42.35,20.26,18.41-23,18.41-23l-7.37-18.41-139-26.7Z'
    transform='translate(-90 -115.91)' opacity='0.05' />
    ...
    transform='translate(-90 -115.91)' fill='#737a9d' />
    <path d='M593.94,555.29l79.18,36.83s24.86-19.34,23-29.46l-92.07-22.1Z'
    transform='translate(-90 -115.91)' fill={props.accentColor} />
    <path d='M593.94,555.29l79.18,36.83s24.86-19.34,23-29.46l-92.07-22.1Z'
    transform='translate(-90 -115.91)' opacity='0.1' />
    ...
    <path d='M358.23,648.28s6.45,41.43,0,45.12l-4.6-.92-.92-44.19Z' transform='translate(-90 -115.91)'
    fill='#fff' opacity='0.2' />
    <path d='M433.73,644.6l7.37-7.37h35l7.37,7.37s9.21,26.7,1.84,44.19L477,697.08H442l-8.29-7.37Z'
    transform='translate(-90 -115.91)' fill={props.primaryColor} />
    <polygon points='262.71 531.45 263.63 576.57 273.76 583.93 308.75 583.93 315.19 574.73 315.19 531.45 305.06 522.24 271.92 522.24 262.71 531.45'
    opacity='0.1' />
    <path d='M433.73,644.6l7.37-7.37h35l7.37,7.37s9.21,26.7,1.84,44.19L477,697.08H442l-8.29-7.37Z'
    transform='translate(-90 -115.91)' opacity='0.1' />
    <path d='M442,646.44s7.37,32.23,0,43.27h-8.29V644.6Z' transform='translate(-90 -115.91)'
    fill='#fff' opacity='0.2' />
    ...
    transform='translate(-90 -115.91)' fill='#cbcdda' />
    <path d='M399.67,400.61s-40.51.92-8.29,68.13c0,0,8.29,27.62,8.29,32.23s41.43,4.6,46,0-7.37-42.35-7.37-59.85S426.37,395.09,399.67,400.61Z'
    transform='translate(-90 -115.91)' opacity='0.05' />
    ...
    fill={props.primaryColor} />
    <path d='M392.3,652s6.45,41.43,0,45.12l-4.6-.92L386.78,652Z' transform='translate(-90 -115.91)'
    fill='#fff' opacity='0.2' />
    <path d='M488.06,647.36l7.37-7.37h35l7.37,7.37s9.21,26.7,1.84,44.19l-8.29,8.29h-35l-8.29-7.37Z'
    transform='translate(-90 -115.91)' fill={props.primaryColor} />
    <path d='M496.34,649.2s7.37,32.23,0,43.27h-8.29V647.36Z' transform='translate(-90 -115.91)'
    fill='#fff' opacity='0.2' />
    ...
    transform='translate(-90 -115.91)' fill={props.hairColor} />
    <g opacity='0.1'>
    ...
    <g opacity='0.5'>
        ...
        fill={props.primaryColor} />
        <path d='M164.45,529s-26.93,4.19-29.32,0l.6-3,28.72-.6Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        <path d='M167.44,591.23l4.79,4.79v22.74l-4.79,4.79s-17.35,6-28.72,1.2l-5.39-5.39V596.62l4.79-5.39Z'
        transform='translate(-90 -115.91)' fill={props.primaryColor} />
        <path d='M166.24,596.62s-20.94,4.79-28.12,0v-5.39h29.32Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        ...
        fill={props.primaryColor} />
        <path d='M211.4,529.93s-26.93,4.19-29.32,0l.6-3,28.72-.6Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        <path d='M214.39,592.16l4.79,4.79v22.74l-4.79,4.79s-17.35,6-28.72,1.2l-5.39-5.39V597.54l4.79-5.39Z'
        transform='translate(-90 -115.91)' fill={props.primaryColor} />
        <path d='M213.2,597.54s-20.94,4.79-28.12,0v-5.39h29.32Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        ...
        fill={props.primaryColor} />
        <path d='M271.28,546.6s-22.17,3.45-24.14,0l.49-2.46,23.64-.49Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        <path d='M273.75,597.83l3.94,3.94v18.72l-3.94,3.94s-14.28,4.93-23.64,1L245.67,621V602.26l3.94-4.43Z'
        transform='translate(-90 -115.91)' fill={props.primaryColor} />
        <path d='M272.76,602.26s-17.24,3.94-23.15,0v-4.43h24.14Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        ...
        fill={props.primaryColor} />
        <path d='M309.94,547.36s-22.17,3.45-24.14,0l.49-2.46,23.64-.49Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
        <path d='M312.4,598.59l3.94,3.94v18.72l-3.94,3.94s-14.28,4.93-23.64,1l-4.43-4.43V603l3.94-4.43Z'
        transform='translate(-90 -115.91)' fill={props.primaryColor} />
        <path d='M311.42,603s-17.24,3.94-23.15,0v-4.43H312.4Z' transform='translate(-90 -115.91)'
        fill='#fff' opacity='0.2' />
    ...
    <g opacity='0.8'>
        ...
        <path d='M199.86,711s5.25,4.13,18,0' transform='translate(-90 -115.91)'
        opacity='0.2' />
        <path d='M198.74,681s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z' transform='translate(-90 -115.91)'
        fill={props.primaryColor} />
        <path d='M198.74,681s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z' transform='translate(-90 -115.91)'
        opacity='0.2' />
        ...
        <path d='M235.5,683s-14.18-7.25-20.52-1.26-7.32,21.3-7.32,21.3S230.78,706.23,235.5,683Z'
        transform='translate(-90 -115.91)' fill='#fff' opacity='0.1' />
        <path d='M207.66,703s3.72-17.77,27.84-20' transform='translate(-90 -115.91)'
        fill='none' stroke={props.primaryColor} strokeMiterlimit='10' />
    </g>
    ...
    transform='translate(-90 -115.91)' fill='#fff' opacity='0.1' />
    <path d='M259.71,733.09s5.25,4.13,18,0' transform='translate(-90 -115.91)'
    opacity='0.2' />
    <path d='M258.58,703.07s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z' transform='translate(-90 -115.91)'
    fill={props.primaryColor} />
    <path d='M258.58,703.07s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z' transform='translate(-90 -115.91)'
    opacity='0.2' />
    ...
    <path d='M295.35,705.1s-14.18-7.25-20.52-1.26-7.32,21.3-7.32,21.3S290.63,728.32,295.35,705.1Z'
    transform='translate(-90 -115.91)' fill='#fff' opacity='0.1' />
    <path d='M267.51,725.14s3.72-17.77,27.84-20' transform='translate(-90 -115.91)'
    fill='none' stroke={props.primaryColor} strokeMiterlimit='10' />
