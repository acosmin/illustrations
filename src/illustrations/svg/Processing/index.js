...
const UndrawProcessing = props => (
  ...
  >
    ...
    />
    <rect x={106} y={266} width={300} height={71} fill={props.primaryColor} />
    <rect x={186} y={283} width={88} height={4} fill={props.primaryColor} />
    ...
    />
    <polygon points="538 512 526 670 538 670 555 512 538 512" fill={props.primaryColor} />
    <polygon
      points="865.16 506 880.92 667 862.16 667 847.08 506 865.16 506"
      fill="url(#861d31c1-c685-4668-90c5-63e7f330b62f)"
    />
    <polygon points="865 507 877 665 865 665 848 507 865 507" fill={props.primaryColor} />
    <polygon
      points="583.9 505 569 666 588.9 666 605 505 583.9 505"
      fill="url(#95aca10b-5f5c-4c4a-b42d-5e0345d77cda)"
    />
    <polygon points="585 505 573 663 585 663 602 505 585 505" fill={props.primaryColor} />
    <polygon
      points="821.69 507 837 672 818.69 672 800 507 821.69 507"
      fill="url(#447533d7-1588-4f38-833a-a610814ab16b)"
    />
    <polygon points="821 512 833 670 821 670 804 512 821 512" fill={props.primaryColor} />
    <rect
      x={513}
      y={503}
      width={359}
    ...
    />
    <rect x={516} y={503} width={288} height={15} fill={props.primaryColor} />
    <rect x={804} y={503} width={66} height={15} fill={props.primaryColor} />
