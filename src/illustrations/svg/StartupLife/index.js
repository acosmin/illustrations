...
const UndrawStartupLife = props => (
  ...
  >
    ...
    <circle cx={21.63} cy={133.13} r={21.63} fill={props.primaryColor} opacity={0.1} />
    <circle cx={608.74} cy={41.99} r={21.63} fill={props.primaryColor} opacity={0.1} />
    <circle cx={951.89} cy={127.44} r={21.63} fill={props.primaryColor} opacity={0.1} />
    <circle cx={64.88} cy={252.46} r={36.25} fill={props.primaryColor} opacity={0.1} />
    <circle cx={507.64} cy={789.47} r={36.25} fill={props.primaryColor} opacity={0.1} />
    <circle cx={990.55} cy={768.57} r={36.25} fill={props.primaryColor} opacity={0.1} />
  </svg>
);
...
export default UndrawStartupLife;
